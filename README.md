...
- grafico de valor por categoria;
- grafico de valor por data;
- tabela detalhada;
...
- A coluna `data` deve conter datas validas.
...
- Erro de colunas ausentes: confirme os cabecalhos `data`, `categoria`, `descricao`, `valor`.
